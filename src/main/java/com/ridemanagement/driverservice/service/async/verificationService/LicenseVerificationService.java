...
@Component
public class LicenseVerificationService implements PersonalVerificationService{
    @Override
    public CompletableFuture<Void> startVerification(DocumentEntity document) {
        System.out.println("send kafka message to scheduler to start License verification");
        return null;
    }
