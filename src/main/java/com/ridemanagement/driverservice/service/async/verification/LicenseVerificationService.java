...
@Component
public class LicenseVerificationService extends AbstractPersonalVerificationService<DocumentKey, Document> implements PersonalVerificationService <DocumentKey, Document> {

    @Override
    protected String getValue() {
        return String.format("{\"documentType\":\"%s\"}", DocumentType.LICENSE);
    }
}
